...
def load_args_species():
    ...
    parser.add_argument('--dataset_train_dir', type=str, default='/lustre/fsn1/projects/rech/bun/ucg81ws/synt_class_dataset/eval_1/classification_dataset/split_A')
    ...
    parser.add_argument('--dataset_test_dir', type=str, default='/lustre/fsn1/projects/rech/bun/ucg81ws/synt_class_dataset/eval_1/classification_dataset/split_E')

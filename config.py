...
def load_args_species():
    ...
    parser.add_argument('--batch_size', type=int, default=64)
    parser.add_argument('--backbone', type=str, default='ResNet18')
    parser.add_argument('--dataset_train_dir', type=str, default='/lustre/fsn1/projects/rech/bun/ucg81ws/image')
    parser.add_argument('--dataset_val_dir', type=str, default='/lustre/fsn1/projects/rech/bun/ucg81ws/image')
    parser.add_argument('--dataset_test_dir', type=str, default='/lustre/fsn1/projects/rech/bun/ucg81ws/image')
    parser.add_argument('--save_path', type=str, default='output/best_model.pt')
    parser.add_argument('--out_path', type=str, default='output/output.csv')
    parser.add_argument('--pretrain_path', type=str, default=None)
    parser.add_argument('--n_window', type=int, default=101)
